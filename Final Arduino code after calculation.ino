...
analogWrite(enA, Speed); // Write The Duty Cycle 0 to 100 Enable Pin A for Motor1 Speed 
analogWrite(enB, Speed); // Write The Duty Cycle 0 to 100 Enable Pin B for Motor2 Speed 
...
if(servo1>10){servo1 = servo1-1;} 
motor_1.write(servo1);  
}

else if (bt_data == 10){
if(servo2>40){servo2 = servo2-1;}
motor_2.write(servo2);
}
else if (bt_data == 11){
...
if(servo5>50){servo5 = servo5-1;}
motor_5.write(servo5);
}
else if (bt_data == 17){
if(servo5<120){servo5 = servo5+1;}
motor_5.write(servo5);
}
